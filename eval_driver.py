...
def parse_args():
    ...
    parser.add_argument('--api-base', default='https://value.apiqik.online/v1')
    parser.add_argument('--api-key', default='sk-F5ldvqxASFDTeZhyeCU2Uz3u7bCwpKkIJ1JURbeGF7ERwIIL')
